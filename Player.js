...
class PlayerState {
    ...
    getStateFromPlayer(player) {
        this.currentPos = player.currentPos.copy(x, y);
...
class Player {
    ...
    constructor() {
        ...
        this.currentPos = new Phaser.Math.Vector2(game.config.width  / 2, game.config.height - 200); // this is the top left corner of the hitbox
        this.currentSpeed = new Phaser.Math.Vector2(0, 0);
        this.isOnGround = false;
        ...
        this.previousSpeed = new Phaser.Math.Vector2(0, 0);
    ...
    clone() {
        let clone = new Player(this.scene, this.x, this.y);
